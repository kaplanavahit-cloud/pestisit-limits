...
export default function RussiaZeroTolerancePage() {
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-red-50 to-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Rusya - Hiçbir Üründe Bulunmaması Gerekenler</h1>
                <p className="text-sm text-gray-500 mt-1">Rusya mevzuatına göre MRL değeri 0 olması gereken maddeler</p>
              </div>
